...
parameters rho_a;                   // technology persistence 
parameters phi_pr;                  // price adjustment cost scaling factor 
parameters phi_inv;                 // investment adjustment scaling factor 
parameters gamma_pr;                // price indexation factor 
parameters prob_f;                  // probability of firing 
parameters alpha;                   // capital share on production 
parameters g_a_ss markup a_ss;

// LABOUR MARKET
parameters alpha_hc;                // hiring costs elasticity w.r.t. probability of hiring 
parameters kappa;                   // hiring costs scaling factor 
parameters sigma;                   // worker bargaining power 
parameters hc_w; 
